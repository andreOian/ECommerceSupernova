			...
			<div id="main">
				<div id="uno">
					<?php
						...
						$email=$_POST['email'];
						$testo=$_POST['testo'];
						$stringaFinale="Inviato dal signore/ditta ".$nome." con email ".$email."\n".$testo;
						...
						$query="INSERT INTO messaggio VALUES('$lung' +1,'$stringaFinale')";
						$result=mysqli_query($con,$query);
						
						$query="INSERT INTO scrive VALUES(CURRENT_TIMESTAMP,'$lung' +1,'$nomeUtente')";
						$result=mysqli_query($con,$query);
						mysqli_close($con);
					?>
