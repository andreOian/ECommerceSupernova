<html>			<!-- NUOVO -->
  ...
  <body>
	    ...
	    <div id="container">
				...
				<div id="navigation">
					<?php
						echo "<ul id='menu'>
								...
								<li class='active'><a href='news2.php?nomeUtente=$nomeUtente'>News</a></li>
			...
			<div id="main">
				<div id="uno">
					<img src="Novità/ProvePumel.jpg" width="450" height="200"><br><br><b>Questa sarà la nuova linea di manici supernova, che rivestiranno i prodotti di quasi tutte le catorie di prodotti supernova. Sono ergonomici, pratici, morbidi e non fanno venire i calli alle mani.</b>
				</div>
			</div><!--#main-->
