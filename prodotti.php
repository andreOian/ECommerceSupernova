<html>			<!-- NUOVO -->
  ...
  <body>
	    ...
	    <div id="container">
			...
			<div id="main">
				<div id="uno">
				<a href="manodomestico.php" class="shiny-button"><strong>MANODOMESTICO</strong></a>
				<a href="linea_da_tavola.php" class="shiny-button2"><strong>LINEA DA TAVOLA</strong></a>
				<a href="gadget.php" class="shiny-button3"><strong>GADGET</strong></a>
				<a href="espositori.php" class="shiny-button4"><strong>ESPOSITORI</strong></a>
				</div>
			</div><!--#main-->
